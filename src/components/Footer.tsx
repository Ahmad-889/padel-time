      ...
      <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between px-margin-desktop max-w-container-max mx-auto">
        ...
        <div className="flex flex-col items-center md:items-start gap-3">
          ...
          <p className="font-body-md text-[0.85rem] text-on-surface-variant opacity-70">
            &copy; {new Date().getFullYear()} Padel Time Lahore. All Rights Reserved.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <a
            href="https://www.linkedin.com/in/muhammad-ahmad-784271337/"
            target="_blank"
        ...
        <div className="flex gap-4 justify-center md:justify-end">
          <a
            ...
            href="https://l.instagram.com/?u=https%3A%2F%2Fwww.facebook.com%2Fshare%2F17nAftRYZW%2F%3Futm_source%3Dig%26utm_medium%3Dsocial%26utm_content%3Dlink_in_bio&e=AUBovaRdS6vPla0U8q15EBiGFKB_QK3tUtVrLD31CuFgw3MKubMsfScmcw8x_08QT549YMEvV-L2b8NmHuXx8xBaWUwRf1KLIMbf8Uzp8DjZ816YNe0BrrwOftcda9qJMHa68gw"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-on-surface-variant hover:text-secondary hover:border-secondary transition-all"
            href="https://www.instagram.com/padeltime.pk?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          >
